...
function registerNoteHandlers(noteService) {
  ...
  registerHandler('notes:create', (noteData) => noteService.createNote(noteData))

  registerHandler('notes:update', (noteId, noteData) => noteService.updateNote(noteId, noteData))

  registerHandler('notes:move-to-trash', (noteId) => noteService.moveToTrash(noteId))

  registerHandler('notes:restore', (noteId) => noteService.restoreNote(noteId))

  registerHandler('notes:permanently-delete', (noteId) => noteService.permanentlyDeleteNote(noteId))
}
